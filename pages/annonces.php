        ...
        <div class="annonces-col">
            ...
            <div class="annonces-card">
                        ...
                        if (!empty($depart) and !empty($arrivee) and !empty($_GET['date_dep'])) {
                            if (isset($_GET['search'])) {
                                ...
                                <div class="annonce_alert">
                                    ...
                                    <a href="report/trip-alert"><button class="create-alert">Créer rapidement une alerte</button></a>
                                    <hr>
                                    <form method="GET">
                                        <?php
                ...
                <?php
                        ...
                        // setflash("Votre recherche ne correspond pas aux critères, Réessayer", "error-annonces");
                        ?>
                        <script>alert("Votre recherche ne correspond pas aux critères, Réessayer");</script>
                        <?php
