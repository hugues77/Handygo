  ...
  modPlus.addEventListener("click", ()=>{
    ...
    // a = (a < 10) ? "0" + a : a;
    // num.innerHTML =  a;
    modNum.value = parseInt(modNum.value) + 1;
  ...
  let TextareaMod = document.querySelector("form .trip-confirm .descrip-voy textarea");
  ...
  const update_trip_itiner = document.querySelector('form .trip-itineraire .btn-itineraire');
  const update_trip_date = document.querySelector('form .trip-date .btn-date');
  const update_trip_bagage = document.querySelector('form .trip-bagage .btn-bagage');
  const update_trip_paiement = document.querySelector('form .trip-paiement .btn-paiement');
  const update_trip_confirmation = document.querySelector('form .trip-confirm .btn-confirmation');

  const errorModifyPostTrip = document.querySelector(".form-modify-trip .error-post-trip");
