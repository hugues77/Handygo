...
if(isset($_SESSION['unique_id'])){
    ...
    if(isset($_SESSION['ref'])){
        ...
        if(!empty($date_depart) && !empty($date_arrivee) && !empty($h_depart) && !empty($h_arrivee)){ 
            //Update the data of trip for date part
            update_trip_date($date_depart, $date_arrivee, $h_depart, $h_arrivee, $_SESSION['ref'],  $date_voy);
            echo 'success';
        }else{
